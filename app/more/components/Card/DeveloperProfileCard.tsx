...
export default function DeveloperProfileCard({
  ...
  return (
    <Link href={writerURL === '' ? '#' : member_link} target="_blank">
      <div className="link-to-wakzoo_about flex min-h-[120px] w-full min-w-10 max-w-[346px] items-center justify-start gap-4 rounded-2xl bg-gray-200 px-4 py-2 shadow-base transition hover:bg-gray-300 active:bg-gray-400 dark:bg-dark-card-2 dark:hover:bg-whiteAlpha-300 dark:active:bg-whiteAlpha-400">
