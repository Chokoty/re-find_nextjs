...
export default function SubscribeConfirmModal(props: Record<string, unknown>) {
  const handleSubscribe = props.handleSubscribe as () => void;
    ...
    <section className="relative m-auto w-[92%] max-w-lg rounded-2xl bg-white p-6 shadow-xl dark:bg-dark-card">
      ...
      <div className="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
        <button
          type="button"
          onClick={close}
          className="h-10 w-full rounded-md border border-gray-300 bg-gray-100 px-4 font-semibold text-gray-700 transition hover:bg-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600 sm:w-auto"
        >
          닫기
        </button>
        <button
