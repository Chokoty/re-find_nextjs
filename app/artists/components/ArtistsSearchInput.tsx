...
export default function ArtistsSearchInput() {
  ...
  return (
    <div className="relative h-10 w-full max-w-[400px]">
      ...
      <input
        className="relative size-full cursor-text rounded-full border border-gray-200 bg-white pl-12 pr-14 outline-none transition placeholder:text-gray-500 hover:border-green-highlight focus:border-green-highlight focus:outline-none focus:ring-1 focus:ring-green-highlight dark:border-whiteAlpha-300 dark:bg-dark-card dark:placeholder:text-whiteAlpha-600 dark:hover:bg-whiteAlpha-200 2xs:pr-24"
        placeholder="왁물원 닉네임"
        value={input}
