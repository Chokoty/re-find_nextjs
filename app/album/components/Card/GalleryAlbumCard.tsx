...
export default function GalleryAlbumCard({
  ...
  return (
    <Link
      ...
      prefetch={false}
      className="m-auto flex h-[220px] max-w-[144px] flex-col items-center justify-start gap-2 rounded-md p-3 transition hover:bg-gray-200 active:bg-whiteAlpha-400 dark:hover:bg-whiteAlpha-300 dark:active:bg-black-200 md:h-[256px] md:w-full md:max-w-[180px]"
    >
