    ...
    <div className="flex w-full flex-col items-center justify-center sm:items-start sm:justify-start">
      {pageType === 'galleryHome' ? (
        ...
        <>
          ...
          <h1 className="font-pop my-3.5 text-2xl 2xs:text-4xl md:text-5xl 2md:text-[4rem]">
            {title}
          </h1>
          <div className="mb-6">
...
const GalleryHomeTitle = () => {
  return (
    <div className="font-pop flex h-[72px] items-center justify-center text-4xl 2xs:text-5xl md:h-[120px] md:text-[80px]">
