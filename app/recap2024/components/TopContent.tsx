...
export default function TopContent({
  ...
  return (
    <div className="m-auto flex w-full max-w-screen-xl flex-col items-center justify-between lg:w-[90%]">
      <div className="m-8 flex w-full flex-col items-center justify-center gap-2 text-start  text-base lg:text-3xl ">
        <p className="w-full">
        ...
        <p className="w-full">2025년에도 작가님들의 활동을 응원합니다! 킹아!</p>
      </div>
