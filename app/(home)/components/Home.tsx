...
export default function Home() {
  return (
    <div className="mx-auto my-4 flex w-full max-w-[1208px] flex-wrap items-start justify-center gap-6 bg-background">
      <EventModal />
      {/* desktop: left / mobile: top */}
      <section className="flex size-full w-[90%] max-w-[700px] flex-col items-center justify-center md:w-full">
        <BannerSlider />
        <TopTitle />
        <Upload />
      </section>
      {/* desktop: right / mobile: bottom */}
      <section className="flex size-full max-w-[400px] flex-col items-center justify-center">
        <div className="hidden w-[90%] flex-col items-center rounded-2xl bg-card px-6 pb-4 pt-6 shadow-cardBox md:flex">
