            ...
            <>
              ...
              <AccordionPanel>
                <div className="my-4 w-full break-keep rounded-md border-2 border-green-highlight p-4 text-sm dark:border-pink-highlight md:p-6">
                  ...
                  >
                    ...
                    <li>
                      <p className="mt-2 font-bold">
                        왁물원에 새로 올라온 팬아트가 반영되기까지 시간이 좀
                        걸릴 수 있습니다.(길면 하루 정도)
                      </p>
                    </li>
                    <li>
                      <p className="mt-2 font-bold">
                        현재 상단에 명시된 게시판에 올라온 것만 찾을 수
                        있습니다. (아직 자유 게시판이나 웹툰 게시판에 올라온
                        것은 찾을 수 없습니다.)
                      </p>
                    </li>
                    <li>
                      <p className="mt-2 font-bold">
                        게시글이 존재하는 이미지여도 못 찾는 모시깽이가 가끔
                        있습니다.
                      </p>
                    </li>
                  </ul>
                  ...
                  <p className="font-bold">
                    구글 이미지 검색을 활용하여 다른 곳에 업로드된 이미지를 찾은
                    뒤, 그걸로 검색하면 간혹 찾을 수 있습니다. &nbsp;
                    <Link
                      className="contents"
