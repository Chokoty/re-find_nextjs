...
export default function RandomFanart() {
  ...
  return (
    <div className="mx-auto mt-8 flex min-h-[120px] w-full max-w-[540px] flex-col items-center justify-center rounded-2xl border-base bg-white p-6 dark:bg-dark-card-2">
