...
const members: Member[] = [
  ...
  { id: 3, name: '아이네', value: 'ine', keyword: '아이네' },
  { id: 4, name: '징버거', value: 'jinburger', keyword: '징버거' },
  { id: 5, name: '릴파', value: 'lilpa', keyword: '릴파' },
  { id: 6, name: '주르르', value: 'jururu', keyword: '주르르' },
  { id: 7, name: '고세구', value: 'gosegu', keyword: '고세구' },
